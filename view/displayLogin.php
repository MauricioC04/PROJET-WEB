...
<div class="login-dark" style="background-position: center;background-image: url(&quot;view/content/images/useful/arriere-plan.jpg&quot;);background-repeat: no-repeat;background-size: cover;">
    <form method="post" style="background-color: #f0f9ff;" action="index.php?action=login">
        ...
        <div class="illustration">
            ...
            <?php if (@$_GET['loginError'] == true) :?>
                <h5 class="alert alert-danger text-center mb-4">Email ou mot de passe incorrect</h5>
            <?php endif ?>
        <?php if (@$_GET['connexionRequiredError'] == true) :?>
            <h5 class="alert alert-danger text-center mb-4">Veuillez vous connecter ou créer un compte avant d'élaborer votre panier</h5>
        <?php endif ?>
